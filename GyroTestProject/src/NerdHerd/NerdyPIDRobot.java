...
public class NerdyPIDRobot{
    ...
    */
        ...
        HeadingIntegrator = new TrapezoidalIntegrator(0.040, 100);
        DistanceIntegrator = new TrapezoidalIntegrator(0.040,16);
        DistanceRemainingIntegrator = new TrapezoidalIntegrator(0.040);
        speedIntegrator = new TrapezoidalIntegrator(0.040, 4.5);
    ...
    */
       ...
       /* if(Math.abs(yAxis)<.0075){
            yAxis = 0;
        }
        if(Math.abs(xAxis)<.0075){
            xAxis = 0;
        }
        */
        //double acceleration = sign(yAxis) * sign(xAxis) * Math.sqrt(sqr(Math.floor(yAxis)) + sqr(Math.floor(xAxis)));
        double acceleration = xAxis;
        speedTraveling += acceleration*0.040*9.81;
    ...
    */
        ...
        double PIDOutputAngular = ((err * KpAngular) * KdAngular*angularScaleFactor*0.5);
    ...
    */
       ...
       //System.out.println("Desired Angle is :\t" + desiredAngle);
        ...
        try{
            ...
            LtDriveSub.set(ltPower);
            RtDriveMain.set(rtPower);
            RtDriveSub.set(rtPower);
        }catch (Exception e){
            System.out.println(e);
        }
    }
    ...
    */
        ...
        try{
            ...
            LtDriveSub.set(linearPower);
            RtDriveMain.set(-linearPower);
            RtDriveSub.set(-linearPower);
        }catch (Exception e){
            System.out.println(e);
        }
    }
