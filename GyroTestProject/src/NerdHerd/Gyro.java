...
public class Gyro extends SensorBase implements PIDSource, ISensor, LiveWindowSendable {
    ...
    public double getRate() {      
        if(m_analog == null) {
            ...
            return Math.floor((m_analog.getAverageValue() - ((double)m_center + m_offset)) * 1e-9 * m_analog.getLSBWeight() 
                    / ((1 << m_analog.getOversampleBits()) * m_voltsPerDegreePerSecond)*100)/100;
        }
    }
